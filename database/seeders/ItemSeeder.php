...
class ItemSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('items')->insert([
            ...
            ['id' => 31, 'created_at' => Carbon::create('2021', '01', '01'), 'updated_at' => Carbon::create('2021', '01', '01'), 'name' => 'Miss Sixty adjustable Metallic Top', 'photo' => "31a,31b", 'quality' => 3, 'country' => 'Peru', 'category_id' => 13, 'type_id' => 1],
