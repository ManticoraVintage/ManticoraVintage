...
class TypeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('types')->insert([
            ['id' => 1, 'created_at' => Carbon::create('2021', '01', '01'), 'updated_at' => Carbon::create('2021', '01', '01'), 'name' => 'vintage', 'description' => $vintageDescription],
            ['id' => 2, 'created_at' => Carbon::create('2021', '01', '01'), 'updated_at' => Carbon::create('2021', '01', '01'), 'name' => 'selected', 'description' => ''],
