<template>
  <div class="main d-flex">
    ...
    <div class="vertical-navbar d-flex flex-column">
      ...
      <div
        class="profile-details d-flex justify-content-center align-items-center"
      >
        <div
          class="profile-image d-flex justify-content-center align-items-center"
        >
          <img src="images/logo_manticora_mini.png" style="width: 150px" />
        </div>
      </div>
    ...
    <div class="information-container d-flex flex-column" style="z-index: 1000">
      <modal-vue
        class="deletePopup"
              ...
              <tbody>
                <tr v-for="(cloth, index) in filteredList" :key="index">
                  ...
                  <td style="width: 130px">
                    {{ cloth.item.quality }}
                    <i class="fas fa-star" style="color: #ee2a7b"></i>
                  </td>
                  ...
                  <td>
                    ...
                    >
                      <button
                        class="action-button"
                        style="border: 0px"
                        v-on:click="showDeletePopup2(category.id, index)"
                      >
                        <i class="fas fa-trash"></i>
                      </button>
                      <button class="action-button" style="border: 0px">
                        <i class="fas fa-edit"></i>
                      </button>
                    </div>
                    <!-- </form> -->
      ...
      <div v-if="isViewTypeActive" class="table-container">
        ...
        <div class="view-all-table" v-bind:class="{ active: isViewTypeActive }">
          <div
            class="error"
            v-bind:class="{ correct: typeMsg }"
            style="width: 100%"
          ...
          <div class="table-body">
            <table>
              <tbody>
                <tr v-for="(type, index) in filteredTypes" :key="index">
                  ...
                  <td>
                    ...
                    >
                      <button
                        class="action-button"
                        style="border: 0px"
                        v-on:click="showDeletePopup3(type.id, index)"
                      >
                        <i class="fas fa-trash"></i>
                      </button>
                      <button class="action-button" style="border: 0px">
      ...
      >
        <form
          ...
          @submit="preventSubmit"
        >
          <h4 style="margin-botton: 10px; width: 100%; font-weight: bold">
          ...
          <div>
            ...
            <input v-model="itemToAdd.name" type="text" name="name" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" v-model="itemToAdd.size" name="size" required />
          </div>
          <div>
          ...
          <div>
            ...
            <input type="text" name="url" v-model="itemToAdd.url" required />
          </div>
          ...
          <div>
            ...
            >
              <option value="" selected>--Selecciona the type--</option>
              <option
                :value="type.name"
          ...
          <div class="button-container d-flex justify-content-between">
            <button type="submit" v-on:click="addItem()">Add Item</button>
            <button type="submit" v-on:click="openTab(3)">Return</button>
          </div>
        </form>
      ...
      >
        ...
        >
          ...
          <div>
            <label for="name">Name</label>
            <input v-model="categoryToAdd.name" type="text" name="name" />
          </div>
          <div class="button-container d-flex justify-content-between">
      ...
      >
        ...
        >
          ...
          <div>
            <label for="name">Name</label>
            <input v-model="typeToAdd.name" type="text" name="name" />
          ...
          <div class="button-container d-flex justify-content-between">
            <button type="submit" v-on:click="addType()">Add Type</button>
            <button type="submit" v-on:click="openTab(3)">Return</button>
          </div>
        </form>
        <p style="display: none">{{ showRequestStatus() }}</p>
    ...
    >
      <div class="edit-cloth-modal">
        ...
        >
          <div>
            <input hidden v-model="itemToEdit.id" type="text" name="id" />
          ...
          <div>
            <label for="size">Size</label>
            <input type="text" v-model="itemToEdit.size" name="size" />
          </div>
          <div>
            <label for="quality">Quality(1-5)</label>
            <input type="number" name="quality" v-model="itemToEdit.quality" />
          </div>
          <div>
            <label for="country">Country</label>
            <input type="text" name="country" v-model="itemToEdit.country" />
          </div>
          <div>
            <label for="photoName">Photo name</label>
            <input
          ...
          <div>
            ...
            <input type="text" name="url" v-model="itemToEdit.url" />
          </div>
          <div>
          ...
          <div class="button-container d-flex justify-content-between">
            <button type="submit" v-on:click="editCloth()">Confirm</button>
            <button type="submit" v-on:click="openTab(7)">Return</button>
          </div>
        </form>
      </div>
    </div>
    ...
    editCloth() {
      try {
        const response = axios
          .put(`api/admin/edit/cloth/${this.itemToEdit.id}`, this.itemToEdit)
          .then((response) => {
